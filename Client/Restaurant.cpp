...
D3DXVECTOR3 & CRestaurant::Get_Pos()
{
	// TODO: 여기에 반환 구문을 삽입합니다.
	return playerPos;
}

int CRestaurant::Update()
{
...
HRESULT CRestaurant::Initialize()
{
	return S_OK;
}

HRESULT CRestaurant::LateInitialize()
{
	...
	ShopImage.Texture.wstrObjectKey = L"Inn";
	ShopImage.Texture.wstrStateKey = L"InnIdle";
	...
	pwI = CMyRestaurant::Create();


	return S_OK;
}

void CRestaurant::Release()
{
}

CRestaurant * CRestaurant::Create()
{
	CRestaurant* m_pInstance = new CRestaurant;
